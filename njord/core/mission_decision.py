...
_DECISIONS = {
    ...
    3: {
        ...
        "PARALLEL_TURN_FIRST": ("DOCKING", "Turn left for parallel docking", "Dock stopping distance was confirmed", "", False),
        "PARALLEL_SHIFT_FORWARD": ("DOCKING", "Apply parallel-dock position correction", "First parallel turn is complete", "", False),
        "PARALLEL_TURN_FINAL": ("DOCKING", "Finish parallel docking heading", "Parallel position correction is complete", "", False),
